...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="antialiased">
      <form action="/empresario{{isset($empresario)?('/'.$empresario->id):('')}}" method="{{isset($empresario)?('POST'):('POST')}}">
        @if(isset($empresario))
        {{ method_field('PATCH') }}
        @endif
        ...
        <div class="form-group">
          ...
          <input type="text" class="form-control" name="razonsocial" value="{{isset($empresario)?($empresario->razonsocial):('')}}" placeholder="Razón Social">
        </div>
        <div class="form-group">
          <label for="formGroupExampleInput">Nombre</label>
          <input type="text" class="form-control" name="nombre" value="{{isset($empresario)?($empresario->nombre):('')}}" placeholder="Nombre">
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
          ...
          <input type="text" class="form-control" name="estado" value="{{isset($empresario)?($empresario->estado):('')}}" placeholder="estado">
        </div>
        <div class="form-group">
          <label for="formGroupExampleInput">Ciudad</label>
          <input type="text" class="form-control" name="ciudad" value="{{isset($empresario)?($empresario->ciudad):('')}}" placeholder="ciudad">
        </div>
        <div class="form-group">
          <label for="formGroupExampleInput">Telefono</label>
          <input type="text" class="form-control" name="telefono" value="{{isset($empresario)?($empresario->telefono):('')}}" placeholder="telefono">
        </div>
        <div class="form-group">
